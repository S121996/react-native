...
const SearchUseEffectComponent = () => {
  ...
  const DeleteItem=(product)=>{
    const newData = data.filter(item => item.product !== product);
    setData(newData);
  }
      ...
      {productData.map((product) => (
        <View style={styles.productContainer}>
          ...
          {/* <Text style={styles.headerText}>{product.title}</Text> */}
            ...
            <Button title='X' onPress={DeleteItem}></Button>
...
export default SearchUseEffectComponent
